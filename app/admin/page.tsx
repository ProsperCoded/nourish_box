  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-full">
        <Activity className="w-12 h-12 animate-spin text-brand-logo_green" />
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-gray-600 mt-1">Here's what's happening with Nourish Box today.</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <motion.div
            ...
            className="bg-white rounded-xl shadow-lg p-6 h-80 flex flex-col justify-center items-center text-center hover:shadow-2xl transition-shadow duration-300"
          >
          ...
          >
            <h3 className="text-xl font-semibold text-gray-700 mb-4">Recently Added Recipes</h3>
                ...
                {recentRecipes.map((recipe, index) => (
                  ...
                  >
                    <div className="flex items-center">
                      <BookOpen size={18} className="mr-3 text-brand-logo_green" />
                      <div>
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-lg p-6 space-y-4 h-full hover:shadow-2xl transition-shadow duration-300"
        >
          <h3 className="text-xl font-semibold text-gray-700 mb-4">Recent User Activity</h3>
          {recentUsers.length > 0 ? (
            <ul className="space-y-3">
              {recentUsers.map((user, index) => (
                ...
                >
                  <Users size={18} className="mr-3 text-brand-btn_orange" />
                  <div>
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
             <h4 className="text-md font-semibold text-gray-600 mb-3">System Alerts</h4>
