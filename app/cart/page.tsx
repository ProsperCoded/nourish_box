    ...
    const handlePaystackSuccessAction = async (reference: any) => {
        ...
        try {
            ...
            if (verifyData.success) {
                alert(
                    `Payment successful! Amount: NGN ${verifyData.data?.amount?.toLocaleString() ||
            ...
            <div className="flex flex-col items-center justify-center">
                {cartItems.length === 0 ? (
                    ...
                    cartItems.map((item: CartItem) => {
                        ...
                        return (
                            <div
                                className={`border-[1px] border-solid rounded-lg py-2 relative my-2 border-gray-300 text-gray-600 w-11/12 ${itemLoading ? "opacity-70" : ""
                                    }`}
                                key={item.id}
                            >
