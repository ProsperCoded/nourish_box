  ...
  return (
   ...
   fill
    ...
    <div className="absolute inset-0 flex items-center justify-center px-20 py-10 ">
      ...
      <p className="" >Our recipes are the heart and soul of our culinary community, and they reflect our commitment to providing you with memorable and delightful dining experiences.</p>
      <Image src={bread} alt="bread emoji" className="absolute top-0 right-[22px] w-[80px]"/>
      <button className="bg-brand-btn_orange  w-1/2 py-2 px-1 rounded-xl text-white  my-4">Learn more</button>
      </div>
