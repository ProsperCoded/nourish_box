        ...
        <div className="min-h-screen bg-gray-50">
            ...
            {showNotesModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className={`bg-white rounded-lg shadow-xl w-full ${isMobile ? 'max-w-full mx-4' : 'max-w-md'} p-6`}>
                        ...
                        <div className="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 border border-transparent rounded-md text-sm font-medium text-white ${deliveryNotes.trim() ? 'bg-orange-600 hover:bg-orange-700' : 'bg-gray-400 cursor-not-allowed'}`}
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div className="ml-3 flex-1">
                                                ...
                                                <div className="mt-4">
                                                    ...
                                                    >
                                                        <svg className="-ml-1 mr-1 h-4 w-4 text-orange-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                                        </svg>
                                                        {order.restaurantNotes ? 'Edit instructions' : 'Add instructions'}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {activeTab === 'current' ? (
                                        <>
                                            ...
                                            <Link href='/contact_us' className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="h-5 w-5 mr-2 text-orange-500"
                                                    viewBox="0 0 20 20"
                            ...
                            <div className="p-6">
                                ...
                                {activeTab === 'current' && order.restaurantNotes && (
                                    <div className="mt-4">
                                        ...
                                        <p className="text-sm text-gray-600">{order.restaurantNotes}</p>
                                    </div>
                                )}
                            </div>
                        </div>
