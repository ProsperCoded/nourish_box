    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex justify-center">
        <div className="flex flex-col lg:flex-col items-center lg:justify-between py-4  lg:py-10  ">
          <div className="">
            <h2 className="font-medium font-custom text-3xl lg:text-5xl mb-[5px]">
              Discover, Create, Share
            </h2>
            <p className="font-inter text-center text-lg lg:pb-5 font-light text-brand-sub_gray lg:text-2xl">
      ...
      <div className="flex flex-wrap gap-6 justify-center p-6 lg:p-10 pt-0">
        {(showSearch ? searchResult : recipeCards).map((recipe) => (
          <Popup
            trigger={<RecipeCard key={recipe.id} recipe={recipe} />}
            modal={true}
            nested={true}
            key={recipe.id}
          >
